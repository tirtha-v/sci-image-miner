...
Usage:
    python prepare_external_data.py --aclfig --output data/train_augmented.csv
    python prepare_external_data.py --docfigure data/external/DocFigure_dataset --output data/train_augmented.csv
    python prepare_external_data.py --aclfig --docfigure data/external/DocFigure_dataset --output data/train_augmented.csv
"""
