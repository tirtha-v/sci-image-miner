...
(
    ...
    CUDA_VISIBLE_DEVICES=0 $PYTHON tasks/task1_classification/predict_zeroshot.py \
        --model llava \
        --test-root "$DEV_ROOT" \
...
(
    ...
    CUDA_VISIBLE_DEVICES=1 $PYTHON tasks/task1_classification/predict_zeroshot.py \
...
(
    ...
    CUDA_VISIBLE_DEVICES=2 $PYTHON tasks/task1_classification/predict_zeroshot.py \
        --model llava_1_5 \
        --test-root "$DEV_ROOT" \
...
(
    ...
    CUDA_VISIBLE_DEVICES=3 $PYTHON tasks/task1_classification/predict_zeroshot.py \
        --model llama_vision \
        --test-root "$DEV_ROOT" \
