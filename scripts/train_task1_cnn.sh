...
#
# Usage:
#   bash scripts/train_task1_cnn.sh
...
(
    ...
    CUDA_VISIBLE_DEVICES=0 $PYTHON tasks/task1_classification/finetune_cnn.py \
...
(
    ...
    CUDA_VISIBLE_DEVICES=1 $PYTHON tasks/task1_classification/finetune_cnn.py \
...
for MODEL in efficientnet_b0 inception_resnet_v2; do
    ...
    CUDA_VISIBLE_DEVICES=0 $PYTHON tasks/task1_classification/predict_cnn.py \
        --model "$MODEL" \
